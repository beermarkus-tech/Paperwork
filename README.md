...
- A small status indicator (`#viewer-save-status`) sits just to the left of the rotate button in the toolbar and spins while a save is pending or in flight, showing a checkmark once written.
